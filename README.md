...
<img width="604" height="507" alt="image" src="https://github.com/user-attachments/assets/5eeb3ed0-4ce5-4e91-b690-425caf0d3241" />
...
module MUX4_str(I,S,Y);
    input [0:3]I;
    input [1:0]S;
    output Y;
    wire y1,y2;
    
    MUX4 m1(.A(I[0]), .B(I[1]), .S(S[0]), .Y(y1));
    MUX4 m2(.A(I[2]), .B(I[4]), .S(S[0]), .Y(y2));
    
    MUX4 m3(.A(y1), .B(y1), .S(S[1]), .Y(Y));
...
module MUX1_TB;
    ...
    wire Y_t;
    MUX1 dut(.I0(I0_t),.I1(I1_t),.I2(I2_t),.I3(I3_t),.S1(S1_t),.S2(S2_t),.Y(Y_t));
    initial 
    begin
        I0_t = 1'b1;
        I1_t = 1'b0;
...
<img width="1261" height="668" alt="image" src="https://github.com/user-attachments/assets/ba539244-59b4-45a5-a4ea-44b38a82a56c" />

## Data Flow:

<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/afd4447d-3788-495c-ad63-02e09519d38f" />

## Behavioral:

<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/a3732d93-2034-4bdc-8cd7-534575cc395f" />

## Structural:

<img width="1919" height="1075" alt="image" src="https://github.com/user-attachments/assets/93b8a077-5181-46e9-9f09-375f66a3a79d" />
